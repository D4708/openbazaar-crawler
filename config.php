...
// HTTP
define('PROJECT_NAME', 'OpenBazaar.info');
define('PROJECT_DOMAIN', 'openbazaar.info');
define('PROJECT_HOST', 'https://openbazaar.info');
...
// Sitemap
define('SITEMAP_BASE', ''); #file path
define('SITEMAP_DOMAIN', 'https://openbazaar.info');
...
//System
define('SYSTEM_GO_PATH', '');
define('SYSTEM_OPENBAZAAR_PATH', '');
...
define('LOG_ERROR_PATH', '/var/log/openbazaar/openbazaar-crawler.log');
